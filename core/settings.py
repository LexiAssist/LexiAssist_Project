...
SECRET_KEY = 'django-insecure-xn8^&aajfq*w2lm0ayvf@y3%&g607#4$fiy2w9#!wyqguw*o^h'

# SECURITY WARNING: don't run with debug turned on in production!
import os
DEBUG = 'RENDER' not in os.environ # False if on Render, True if on laptop
...
EMAIL_PORT = 587
EMAIL_USE_TLS = True
EMAIL_HOST_USER = 'olasukanmitayos@gmail.com'  # Replace with your Gmail address
EMAIL_HOST_PASSWORD = 'wlre eabn quli sbel' # Replace with your 16-character App Password
DEFAULT_FROM_EMAIL = 'LexiAssist <olasukanmitayos@gmail.com>'
